...
<body class="">
          ...
          <div class="row"> 
              ...
              <div class="card">
                <div class="card-header card-header-success">
                  <h4 class="card-title ">Rakortek</h4>
                  <p class="card-category"> Rapat Koordinasai Teknis Digunakan untuk melakukan verifikasi usulan</p>
                </div>
			...
			<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  <div class="modal-dialog" role="document">
				<div class="modal-content" >
				  <form id="form-update" method="post" class="form-horizontal" data-toggle="validator" enctype="multipart/form-data" action="../../controller/bidang/update_rakortek.php">
					  
				  <div class="modal-header">
					  <h5 class="modal-title" id="exampleModalLabel">Edit Rakortek</h5>
			...
			<div class="modal fade" id="modal-rincian" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  <div class="modal-dialog" role="document">
				<div class="modal-content" >
				  ...
				  <div class="modal-header">
					  <h5 class="modal-title" id="exampleModalLabel">Rincian Rakortek</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					  <span aria-hidden="true">&times;</span>
					</button>
				  </div>
  ...
  $(document).ready(function(){
	  var tabel_rakortek="tabel_rakortek.php";
  ...
  $(document).on('click','#edit',function(e){
	...
	/*	$("#form-update").submit(function(e) {
		   ...
		   var tabel_rakortek="tabel_rakortek.php";
			...
			$.ajax({
			url: "../../controller/bidang/update_rakortek.php",
					type: "post",
					data: dataform,
	...
	*/
	...
	e.preventDefault();
		$("#modal-rincian").modal('show');
			$.post('modal_rincian_rakortek.php',
				{id:$(this).attr('data-id')},
				function(html){
